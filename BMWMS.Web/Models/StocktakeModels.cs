...
{
    public class StocktakeFilterModel
    {
    ...
    public class CreateStocktakeSessionModel
    {
        public long WarehouseId { get; set; }
    ...
    public class StocktakeSessionListModel
    {
    ...
    public class StocktakeSessionPagedResultModel
    {
        public List<StocktakeSessionListModel> Items { get; set; } = new();
    ...
    public class StocktakeSessionDetailModel
    {
        public long StocktakeSessionId { get; set; }
        public string StocktakeNumber { get; set; } = string.Empty;
        public long WarehouseId { get; set; }
        ...
        public bool CanReview { get; set; }
        public bool CanApprove { get; set; }
        public List<StocktakeLocationModel> Locations { get; set; } = new();
        public List<StocktakeCountLineModel> Items { get; set; } = new();
    }

    public class StocktakeLocationModel
    {
        public long StocktakeSessionId { get; set; }
    ...
    public class StocktakeCountTaskModel
    {
        public long StocktakeSessionId { get; set; }
        public string StocktakeNumber { get; set; } = string.Empty;
        public long WarehouseId { get; set; }
    ...
    public class StocktakeCountLineModel
    {
    ...
    public class StocktakeLocationOptionModel
    {
    ...
    public class StocktakeStaffOptionModel
    {
