...
namespace BMWMS.Business.DTOs.Product
{
    ...
    public class ProductDetailResponseDto : ProductResponseDto
    {
        ...
        public List<ProductStockLocationDto> StockLocations { get; set; } = new();
        public List<ProductWarehousePolicyDto> WarehousePolicies { get; set; } = new();
    ...
    public class ProductWarehousePolicyDto
    {
        public long WarehouseId { get; set; }
        public string WarehouseName { get; set; } = string.Empty;
