...
BEGIN
    ...
    (
        ...
        CONSTRAINT CK_StocktakeSessions_Status CHECK (Status IN ('SCHEDULED','IN_PROGRESS','COUNTED','PENDING_APPROVAL','COMPLETED','CANCELLED','REJECTED'))
    );
END;
GO

/* Khóa nghiệp vụ theo Bin trong suốt thời gian kiểm kho. */
